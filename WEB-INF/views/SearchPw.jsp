                    ...
                    <div class="col-xl-7 col-lg-8">
                        ...
                        <div class="login-form">
                            ...
                            <div class="input-box">
                                ...
                                <div class="single-input-fields">
                                    <label for ="id">회원 아이디</label>
                                  	<span style="color: black; font-weight: bold;">${memberFind.mid}</span>
                                    <hr style="color:#C9C9C9;"/>
                                </div>
                                
                                <div class="single-input-fields">
                                    <label for="mphone">회원 비밀번호</label>
                                    <span style="color: black; font-weight: bold;">${memberFind.mpassword}</span>
                                    <hr style="color:#C9C9C9;"/>
                                </div>
                            ...
                            <div class="login-footer">
                                ...
                                <button class="submit-btn3" onclick="goLogin()">로그인하러가기</button>
                            </div>
